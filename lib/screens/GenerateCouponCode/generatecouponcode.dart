...
import 'package:admin/screens/GenerateCouponCode/components/GenerateBody.dart';
import 'package:admin/screens/Shop_Profile/shop_profile.dart';
import 'package:admin/size_config.dart';
import 'package:flutter/material.dart';

class GenerateCouponCode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child: GenerateBody()),
    );
  }
}
